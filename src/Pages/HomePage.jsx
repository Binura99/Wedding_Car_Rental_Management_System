    ...
    <div className="flex w-full h-screen fixed items-center justify-center bg-black mt-[-64px]">
        ...
        <div className='items-center flex flex-col absolute gap-6 justify-center md:mt-[80px]'>
          ...
          <div className='flex flex-row '>
            <button className='font-lexendG font-medium text-white text-center gap-3 whitespace-nowrap flex w-full my-2 bg-[#CCB195] rounded-3xl p-3 items-center justify-center hover:bg-[#caaa88]/80 cursor-pointer'>
              Book Now
